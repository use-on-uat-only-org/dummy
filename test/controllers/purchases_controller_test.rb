...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { category: @purchase.category, name: @purchase.name, quantity: @purchase.quantity } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { category: @purchase.category, name: @purchase.name, quantity: @purchase.quantity } }
